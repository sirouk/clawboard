...
- For Clawboard repository docs, prefer `~/.openclaw/workspace/projects/clawboard` (or the matching main-workspace `projects/clawboard` path) as the canonical repo root.
