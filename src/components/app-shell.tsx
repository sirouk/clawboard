  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--claw-bg))]">
      <div className="flex min-h-screen flex-col lg:flex-row">
        <aside
          className={cn(
            "border-b border-[rgb(var(--claw-border))] bg-[rgb(var(--claw-panel))] px-4 py-6 lg:min-h-screen lg:border-b-0 lg:border-r transition-all lg:sticky lg:top-0 lg:self-start",
