...
export function computeEffectiveSessionKey(meta, ctx) {
    ...
    const threadId = typeof meta?.threadId === "string"
        ...
        : "";
    const isBoard = (value) => /clawboard:(topic|task):topic-/.test(String(value ?? ""));
